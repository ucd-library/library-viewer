...
(function($) {
	...
	iPanorama.prototype = {
		...
		setYaw: function(yaw, duration) {
			...
			this.yaw.time = 0;
			this.yaw.duration = (duration !== undefined ? duration : 1000);
		...
		setPitch: function(pitch, duration) {
			...
			this.pitch.time = 0;
			this.pitch.duration = (duration !== undefined ? duration : 1000);
		...
		setZoom: function(zoom, duration) {
			...
			this.zoom.time = 0;
			this.zoom.duration = (duration !== undefined ? duration : 500);
		...
		lookAt: function(yaw, pitch, duration=500) {
			this.setYaw(yaw, duration);
			this.setPitch(pitch, duration);
		},
	...
	$.fn.ipanorama = function(CfgOrCmd, CmdArgs) {
		return this.each(function() {
			...
			if (CfgOrCmd == "lookat") {
				...
				instance.lookAt(CmdArgs.yaw, CmdArgs.pitch, CmdArgs.duration);
